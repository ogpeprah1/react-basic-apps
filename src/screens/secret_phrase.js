...
const SecretPhrase = () => {
  ...
  useEffect(() => {
    // Fetch your predefined words or provide them here
    const fetchedWords = [
      "abandon",
      "ability",
      "able",
    ...
    setPredefinedWords(fetchedWords);
  }, []);

  const generateRandomPhrase = () => {
    const remainingWords = [...predefinedWords];
      ...
      {generatedPhrases.length > 0 && (
        <div className={`mt-4 ${isClicked ? "block" : "hidden"}`}>
          ...
          <button
            ...
            className="mt-4 px-3 py-2 text-sm bg-blue-500 text-white font-bold rounded-md
                       cursor-pointer hover:bg-blue-700 duration-1000"
          >
            Save Phrases
          </button>
        </div>
